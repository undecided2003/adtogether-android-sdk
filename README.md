...
```kotlin
dependencies {
    implementation("com.relaxsoftwareapps.adtogether:sdk:0.4.1")
}
```

### 2. Initialize

Initialize the SDK early in your application lifecycle. You can obtain your App ID from the [AdTogether Dashboard](https://www.ad-together.org/dashboard).
